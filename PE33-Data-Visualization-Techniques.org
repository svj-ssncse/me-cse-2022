...
- To apply visulaization techniques for time-series data and ranking patterns (K3)
- To apply visulaization techniques for analyzing the deviation and distribution of data patterns (K3)
- To analyze the correlation and multivariate patterns among data (K3)
- To create a dashboard design for simple applications (K4)
